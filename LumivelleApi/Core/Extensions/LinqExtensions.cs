...
public static class LinqExtensions
{
    ...
    public static IOrderedQueryable<TSource> AscOrDescOrder<TSource>(this IQueryable<TSource> query, Sort sort,
        string propertyName)
    {
        ...
        var sortType = sort == Sort.ASC ? "OrderBy" : "OrderByDescending";
