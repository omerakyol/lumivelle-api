...
public static partial class Messages
{
    ...
    public static string TwoFactorNotSetup => "TwoFactorNotSetup";
    public static string TwoFactorVerifyRequired => "TwoFactorVerifyRequired";
    public static string InvalidPhrase => "InvalidPhrase";
    public static string PhrasesEmpty => "PhrasesEmpty";
    public static string BlockedAlready => "BlockedAlready";
    public static string AccountNotBlocked => "AccountNotBlocked";
    ...
    public static string FileEmpty => "FileEmpty";
    public static string FolderPathEmpty => "FolderPathEmpty";
    public static string FileTypeNotAllowed => "FileTypeNotAllowed";
