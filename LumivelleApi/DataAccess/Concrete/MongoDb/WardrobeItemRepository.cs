...
public class WardrobeItemRepository(MongoDbContext context)
    : MongoDbRepositoryBase<WardrobeItemDocument>(context.MongoConnectionSettings), IWardrobeItemRepository
{
